...
const Home = (props) => {
  return (
    <div className="home-container">
      ...
      <div className="home-hero">
        <div className="home-container01">
          <div className="home-card">
            <h1 className="home-text">SCALE UP YOUR BRAND CREATIVELY</h1>
            <h2 className="home-text01 HeadingThree">
              Your  Brand Solutions to Grow 
            </h2>
            <span className="home-text02">
              We help your business in making the strategic branding, marketing
              tools and also your digital presences in creative ways so you can
              grow your business and more sales. 
            </span>
      ...
      <img alt="image" src="/hero%20-1500h.png" className="home-image04" />
      <section className="home-testimonials">
        <div className="home-container05">
          <div className="home-container06">
            <div className="home-container07">
              <h2 className="home-text03 HeadingOne">Work with us</h2>
              <p className="home-text04 Lead">
                <span className="home-text05">
                  Whatever your qualification is - we got you!
                </span>
              </p>
              <p className="home-text06 Body">
              ...
              <p className="home-text08">Mark Jojansen</p>
              <p className="home-text09 Small">Project manager, Atlassian</p>
        ...
        <div className="home-container25">
          <div className="home-container26">
            ...
            <div className="home-container28">
              ...
              <h1 className="home-text16 HeadingOne">Search and Discover!</h1>
        ...
        <div className="home-container30">
          ...
          <div className="home-container32">
            ...
            <div className="home-container34">
              ...
              <h1 className="home-text20 HeadingOne">Talk and Meet!</h1>
