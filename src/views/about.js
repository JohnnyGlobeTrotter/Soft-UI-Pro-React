...
const About = (props) => {
  return (
    <div className="about-container">
      <Helmet>
        <title>About - Soft UI Pro</title>
        <meta property="og:title" content="About - Soft UI Pro" />
      </Helmet>
      <HeaderFull></HeaderFull>
      <div className="about-profile">
        <img alt="image" src="/bruce-mars-200h.jpg" className="about-image" />
        <div className="about-container01">
          <div className="about-container02">
            <h4 className="about-text">Michael Roven</h4>
            <OutlineBlueButton button="follow"></OutlineBlueButton>
          </div>
          <div className="about-container03">
            <span className="about-text01">
              <span className="about-text02">323</span>
              <span> Posts</span>
            </span>
            <span className="about-text04">
              <span className="about-text05">3.5k</span>
              <span> Followers</span>
            </span>
            <span>
              <span className="about-text08">260</span>
              <span> Following</span>
            </span>
          </div>
      ...
      <div className="about-blog-posts">
        <h1 className="about-text11 HeadingTwo">
          <span></span>
          ...
          <div className="about-container05">
            <div className="about-card">
              <div className="about-container06">
                <h1 className="about-text14">Flexible work hours</h1>
                ...
                <div className="about-container07">
                  <button className="about-button button">
                    <span className="about-text17">Read more</span>
              ...
              <div className="about-container08"></div>
            </div>
          </div>
        </div>
      </div>
      <div className="about-contact">
        <div className="about-container09">
          <div className="about-form">
            <h2 className="about-text18 HeadingOne">
              <span>Say Hi!</span>
            </h2>
            <span className="about-text20 Lead">
              We&apos;d like to talk with you.
            </span>
            <form className="about-form1">
              <label className="about-text21 Label">My name is</label>
              <input
                type="text"
                placeholder="Full Name"
                className="about-textinput Small input"
              />
              <label className="about-text22 Label">I&apos;m looking for</label>
              <input
                type="text"
                placeholder="What you love"
                className="about-textinput1 Small input"
              />
              <label className="about-text23 Label">Your message</label>
              <textarea
                rows="8"
                placeholder="I want to say that..."
                className="about-textarea textarea Small"
              ></textarea>
            </form>
          ...
          <div className="about-info">
            <div className="about-container12">
              ...
              <div className="about-container13">
                <div className="about-container14">
                  ...
                  <a href="tel:+40 772 100 200" className="about-link Small">
                    (+40) 772 100 200
                  </a>
                </div>
                ...
                <div className="about-container16">
                  ...
                  <span className="about-text28 Small">
            ...
            <img alt="image" src="/wave-1.svg" className="about-image1" />
